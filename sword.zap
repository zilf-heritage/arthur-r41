...
?CCL3:	IN?	TH-STONE,HERE \?CCL10
	RETURN	TH-EXCALIBUR
?CCL10:	ADD	TBL,8 >?TMP1
	GET	TBL,1
	INTBL?	P-IT-OBJECT,?TMP1,STACK /?CTR11
	RETURN	TH-SWORD
?CTR11:	RETURN	P-IT-OBJECT
...
?CCL8:	EQUAL?	PRSA,V?GOODBYE \?CCL10
	PRINTR	"""You do well to run. At least you escape with your life, if not your honour."""
...
?CCL19:	PRINTR	"""I will not waste my time in idle chatter. Prepare to defend thyself."""
?CCL16:	ZERO?	CONTEXT \FALSE
	ZERO?	NOW-PRSI \FALSE
	EQUAL?	PRSA,V?TELL \?CCL27
	ZERO?	P-CONT \FALSE
?CCL27:	EQUAL?	PRSA,V?ASK-ABOUT \?CCL31
	EQUAL?	PRSI,CH-BLACK-KNIGHT \?CCL34
	PRINTR	"""I am the guardian of the land that lies beyond."""
?CCL34:	EQUAL?	PRSI,CH-DEMON \?CCL36
	PRINTR	"""He is my master. I do his bidding."""
?CCL36:	EQUAL?	PRSI,TH-BLACK-MEDALLION \?CCL38
...
?CCL40:	EQUAL?	PRSI,CH-LOT \?CCL42
	PRINTR	"""Not a bad fellow, once you get to know him."""
?CCL42:	PRINTR	"""I will not waste my time in idle chatter. Prepare to defend thyself."""
?CCL31:	EQUAL?	PRSA,V?CUT,V?ATTACK \?CCL44
	CALL2	RT-ATTACK-KNIGHT,CH-BLACK-KNIGHT
	RSTACK	
?CCL44:	EQUAL?	PRSA,V?EXAMINE \?CCL46
	PRINTI	"The knight towers above you"
	IN?	TH-BLACK-SWORD,CH-BLACK-KNIGHT \?CND47
	PRINTI	", brandishing a huge sword"
?CND47:	PRINTR	". He is encased from head to foot in jet-black armour, and from his neck hangs a sinister medallion that glows a dull red."
?CCL46:	EQUAL?	PRSA,V?CHALLENGE \FALSE
	ICALL2	THIS-IS-IT,CH-BLACK-KNIGHT
...
?CCL12:	ICALL	RT-PRINT-OBJ,CH-BLACK-KNIGHT,K-ART-THE,TRUE-VALUE
	PRINTI	" nimbly avoids your feeble attempt while launching an attack of his own. He feints a blow to your head, and then suddenly whirls and deals you a fatal blow across your midsection.
"
...
?CCL46:	EQUAL?	TARGET,TH-BLACK-MEDALLION \?CCL58
	...
	PRINTI	" glows fiery red for an instant, and then suddenly disappears in a thunderclap and a flash of lightning. "
