...
; "file : SWORD.ZIL"
; "auth :   $Author:   DEB  $"
; "date :     $Date:   27 Apr 1989 23:57:26  $"
; "revs : $Revision:   1.93  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
...
"You whirl the blade with blinding speed, missing the knight by inches!" CR
				...
				(<EQUAL? .TARGET ,TH-BLACK-MEDALLION>
					...
					<TELL
"You sever the knight's source of power. " The ,TH-BLACK-MEDALLION " glows
fiery red for an instant, and then suddenly disappears in a thunderclap and a
flash of lightning. " The ,TH-BLACK-ARMOUR " teeters for a moment. Then it
crumples to" the ,TH-GROUND ", empty." CR
					>
