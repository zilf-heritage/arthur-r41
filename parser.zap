...
?CND1:	SCREEN	1
	...
	.FUNCT	UPDATE-STATUS-LINE:ANY:0:0,C,N,L,CW,REF,?TMP1
	SCREEN	1
	HLIGHT	H-INVERSE
	LOC	CH-PLAYER >L
...
?CND11:	CURSET	1,1
	...
	PRINTT	?TMP1,STACK
	IN?	L,ROOMS /?CND1
	EQUAL?	L,TH-BEHIND-G-STONE,TH-BEHIND-ROCK,TH-BEHIND-DOOR \?CCL18
	PRINTI	", behind "
	EQUAL?	L,TH-BEHIND-G-STONE \?CCL21
	PRINTI	"gravestone"
	JUMP	?CND1
?CCL21:	EQUAL?	L,TH-BEHIND-ROCK \?CCL23
	PRINTI	"gravestone"
	JUMP	?CND1
?CCL23:	PRINTI	"door"
	JUMP	?CND1
?CCL18:	ZERO?	GL-HIDING /?CCL25
	PRINTI	", behind "
...
?CCL27:	DIROUT	K-D-TBL-ON,K-DIROUT-TBL
	PRINTI	"Salamander"
	DIROUT	K-D-TBL-OFF
	GET	0,24
	DIV	STACK,GL-SPACE-WIDTH
	ADD	STACK,1 >N
	...
	COPYT	K-DIROUT-TBL,?TMP1,STACK
	PRINTT	K-DIROUT-TBL,N
	EQUAL?	GL-PLAYER-FORM,K-FORM-ARTHUR /?CND26
	WINGET	1,K-W-XSIZE >?TMP1
	MUL	34,GL-FONT-X
	SUB	?TMP1,STACK
	CURSET	1,STACK
	ICALL	RT-FORM-MSG,FALSE-VALUE,TRUE-VALUE
?CND26:	ZERO?	REF \?CCL33
	DIV	GL-SL-TIME,180 >?TMP1
	DIV	GL-MOVES,180
	EQUAL?	?TMP1,STACK /?CND32
?CCL33:	SET	'REF,TRUE-VALUE
	DIROUT	K-D-TBL-ON,K-DIROUT-TBL
	PRINTI	"Christmas Day, Compline  "
	DIROUT	K-D-TBL-OFF
	GET	0,24 >N
	WINGET	1,K-W-XSIZE
	SUB	STACK,N
	...
	JUMP	?CND36
?CCL38:	EQUAL?	N,1 \?CCL40
	PRINTI	"St John's Day"
	JUMP	?CND36
?CCL40:	EQUAL?	N,2 \?CCL42
	PRINTI	"Christmas Eve"
	JUMP	?CND36
?CCL42:	PRINTI	"Christmas Day"
?CND36:	PRINTI	", "
	MOD	GL-MOVES,1440 >N
	LESS?	N,180 \?CCL45
	PRINTI	"Matins"
	JUMP	?CND43
?CCL45:	LESS?	N,360 \?CCL47
	PRINTI	"Lauds"
	JUMP	?CND43
?CCL47:	LESS?	N,540 \?CCL49
	PRINTI	"Prime"
	JUMP	?CND43
?CCL49:	LESS?	N,720 \?CCL51
	PRINTI	"Terce"
	JUMP	?CND43
?CCL51:	LESS?	N,900 \?CCL53
	PRINTI	"Sext"
	JUMP	?CND43
?CCL53:	LESS?	N,1080 \?CCL55
	PRINTI	"None"
	JUMP	?CND43
?CCL55:	LESS?	N,1260 \?CCL57
	PRINTI	"Vespers"
	JUMP	?CND43
?CCL57:	PRINTI	"Compline"
?CND43:	PRINTC	32
	DIROUT	K-D-TBL-OFF
	WINGET	1,K-W-XSIZE >?TMP1
	GET	0,24
...
?CND32:	HLIGHT	H-NORMAL
	...
	SET	'GL-SL-VEH,L
	JUMP	?CND58
?CCL60:	SET	'GL-SL-VEH,FALSE-VALUE
?CND58:	SET	'GL-SL-FORM,GL-PLAYER-FORM
...
?BOGUS10:	GET	K-WIN-TBL,0
	...
	ZERO?	STACK /?CND11
	GETB	0,30
	EQUAL?	STACK,IBM,AMIGA,MACINTOSH /?CTR14
	GETB	0,30
	EQUAL?	STACK,DEBUGGING-ZIP /?CTR14
	GETB	0,30
	EQUAL?	STACK,APPLE-2E,APPLE-2C,APPLE-2GS \?CCL15
...
?BOGUS19:	GET	K-WIN-TBL,0
	...
	ZERO?	STACK /?CND23
	RETURN	P?NW
?CND23:	ADD	GL-TL-X,GL-MAP-GRID-X >GL-TL-X
	ADD	GL-TL-Y,GL-MAP-GRID-Y
	SUB	STACK,1 >GL-BR-Y
	GET	K-WIN-TBL,1
	ADD	GL-TL-X,STACK
...
?CND25:	GET	K-WIN-TBL,1
	...
	ZERO?	STACK /?CND30
	RETURN	P?NE
?CND30:	ADD	GL-TL-Y,GL-MAP-GRID-Y >GL-TL-Y
	GET	K-WIN-TBL,1
	SUB	CX,STACK >GL-TL-X
	GET	K-WIN-TBL,0
	ADD	GL-TL-Y,STACK
	...
	ZERO?	STACK /?CND32
	RETURN	P?WEST
?CND32:	ADD	GL-TL-X,GL-MAP-GRID-X >?TMP1
	GET	K-WIN-TBL,1
...
?CND34:	GET	K-WIN-TBL,0
	...
	ZERO?	STACK /?CND36
	RETURN	P?SW
?CND36:	ADD	GL-TL-X,GL-MAP-GRID-X >GL-TL-X
	ADD	GL-TL-Y,GL-MAP-GRID-Y
	SUB	STACK,1 >GL-BR-Y
	GET	K-WIN-TBL,1
	ADD	GL-TL-X,STACK
...
?CND74:	SET	'OPRSO,PRSO
	...
	IN?	V,ROOMS /?CND158
	GETP	V,P?ACTION
	CALL	D-APPLY,STR?12,STACK,M-END >V
...
?CND1:	GET	P-N-WORDS,0
	...
	CALL2	RT-AUTHOR-MSG,STR?14
	RSTACK	
?CCL5:	GET	P-C-WORDS,0
	INTBL?	WD,P-C-WORDS+2,STACK \FALSE
	ISAVE	 >P-CAN-UNDO
	EQUAL?	P-CAN-UNDO,2 \?CCL10
	SET	'P-CONT,-1
	ICALL1	V-$REFRESH
	RFALSE	
?CCL10:	DIROUT	D-TABLE-ON,K-DIROUT-TBL
