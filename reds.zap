...
?PRG1:	GET	VEC,0
	...
	.FUNCT	RED-O-NP:ANY:0:2,N,TYP,A,NP,PP,WD,A1,PTR,?PR-WD,?TMP2,?TMP1
	EQUAL?	N,3 \?CND1
	POP	DATA-STACK >PP
...
?PEN54:	ICALL	MAKE-ROOM-FOR-TOKENS,1,G-LEXV,PTR
	JUMP	?REP50
?CCL53:	GET	G-LEXV,PTR >?PR-WD
	EQUAL?	?PR-WD,W?THE /?REP50
	GET	?PR-WD,4 >?TMP1
	ZERO?	?TMP1 /?PRD65
	PUSH	?TMP1
	JUMP	?PEN63
...
?CCL16:	SET	'P-CONT,-1
	...
	MUL	2,NUM
	GET	?TMP1,STACK >X
	CALL	PERF-MANY,X,FALSE-VALUE,PRSO-NP,STR?24
	ZERO?	STACK \?CND1
	RETURN	M-FATAL
