...
; "file : DRAGON.ZIL"
; "auth :   $Author:   RAB  $"
; "date :     $Date:   28 Apr 1989 16:06:06  $"
; "revs : $Revision:   1.70  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
; "Dragon Puzzle"
			...
			<COND
				(<AND <NOT <FSET? ,CH-DRAGON ,FL-ASLEEP>>
					...
					<COND
						...
						(<G? ,GL-HAIR-CNT 0>
							<TELL "The dragon fries you to a cinder.|">
							<RT-END-OF-GAME>
						)
						(T
							<INC GL-HAIR-CNT>
							<TELL
"As you approach the dragon, he opens his eyes and swats you away with his
tail, saying, \"Now don't get me mad, son. I missed my last dose of medicinal
spirits and I'm in no mood for levity.\"" CR
							>
						)
					>
				)
...
<ROUTINE RT-TH-DRAGON-BODY ("OPT" (CONTEXT <>))
	<COND
		...
		(T
			<TELL ,K-NO-REFER-MSG "that part of the dragon's body.]" CR>
		)
	>
>
