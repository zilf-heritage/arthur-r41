		...
		(T
			<COND
				...
				(T
					<TELL .VERB>
					<COND
						(<EQUAL? .VERB "do" "kiss" "push" "miss" "pass" "toss" "touch" "catch" "snatch">
							<TELL "e">
						)
					>
					<TELL "s">
...
<ROUTINE GO ()
	...
	<CLEAR -1>
	<REPEAT ()
		<TELL "|Would you like to restore a saved position">
		<COND
			(<YES?>
				<V-RESTORE>
			)
...
gravestones, the most famous sword in all England grows out of the
anvil-shaped rock. A shaft of moonlight falls upon the magic runes that
