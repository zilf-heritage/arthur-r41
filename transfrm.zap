...
?CND14:	PRINTI	". You are"
	...
	ICALL2	SETUP-ORPHAN,STR?239
	ICALL2	RT-AUTHOR-MSG,STR?240
	RTRUE	
...
?CTR31:	SET	'GL-FORM-ABORT,TRUE-VALUE
	PRINTI	"You start the transformation, but you suddenly realize that you can't breathe underwater, and quickly revert to your"
...
?CCL44:	ZERO?	FORM \?CCL48
	...
	SET	'GL-FORM-ABORT,TRUE-VALUE
	PRINTI	"You start the transformation back into a human. You suddenly realize that the narrow confines of the tree are not large enough to accommodate your human form, and you quickly revert to your"
	ICALL1	RT-FORM-TYPE-MSG
...
?CTR55:	SET	'GL-FORM-ABORT,TRUE-VALUE
	PRINTR	"You start the transformation into an eel, but suddenly when you try to breathe, your gills fill with dust instead of water. Rather than die of suffocation, you quickly revert to your human form."
...
?CND138:	EQUAL?	GL-WINDOW-TYPE,K-WIN-MAP \?CND154
	EQUAL?	HERE,RM-SHALLOWS,RM-FIELD-OF-HONOUR,RM-FORD /?CCL157
...
?CND154:	ZERO?	FORM \?CND163
	...
	SHIFT	1,K-QUEST-SHIFT
	PUTP	TH-HAWTHORN,P?SCORE,STACK
	CRLF	
	ICALL	RT-PRINT-OBJ,TH-HAWTHORN,K-ART-THE,TRUE-VALUE,STR?241
	PRINTI	" to"
	ICALL	RT-PRINT-OBJ,TH-GROUND,K-ART-THE
	PRINTC	46
	CRLF	
...
?CCL22:	EQUAL?	HERE,RM-MEADOW,RM-PAVILION \?CCL24
	...
	JUMP	?CND6
?CCL24:	EQUAL?	HERE,RM-FIELD-OF-HONOUR,RM-END-OF-CAUSEWAY \?CCL26
...
?CCL29:	EQUAL?	HERE,RM-ABOVE-FOREST \?CCL31
	ZERO?	QUIET /?CCL34
	RETURN	RM-GROVE
?CCL34:	ICALL2	SETUP-ORPHAN,STR?244
	ICALL2	RT-AUTHOR-MSG,STR?245
	RFALSE	
