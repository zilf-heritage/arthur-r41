	...
	.FUNCT	RT-RM-FIELD-OF-HONOUR:ANY:0:1,CONTEXT
...
?CND4:	FSET	RM-ISLAND,FL-SEEN
	PRINTI	" the Field of Honour. To the south is a lake with an island in the middle of it. To the east is a causeway leading to the island. The meadow lies to the northwest.
"
	RFALSE	
?CCL3:	EQUAL?	CONTEXT,M-BEG \?CCL13
	IN?	CH-LOT,RM-FIELD-OF-HONOUR \FALSE
...
?CCL7:	RETURN	RM-SHALLOWS
	...
	MOVE	CH-COURTIERS,RM-FIELD-OF-HONOUR
...
Anger flashes in the evil king's eyes. ""Enough!"" he cries. ""This stripling has impugned the honour of the king. He must answer for it on the Field of Honour.""
...
?CND1:	ICALL2	RT-MOVE-ALL-BUT-WORN,CH-PLAYER
	...
	PRINTI	" and then they force-march you along behind Lot. The entourage sweeps out of the Castle, into the town, and south to the Field of Honour. Townspeople follow the procession, and by the time the guards turn you loose, you face King Lot man to man, surrounded by a cheering mob.
"
	ICALL	RT-SCORE-MSG,10,0,0,5
	SET	'OHERE,HERE
	MOVE	CH-PLAYER,RM-FIELD-OF-HONOUR
	SET	'HERE,RM-FIELD-OF-HONOUR
...
?CND6:	CRLF	
	RTRUE	
?CCL5:	PRINTI	"Lot finds a fatal weakness in your defense and runs you through with his sword. You fall to the ground, and as your life's blood slowly drains away, the crowd cheers Lot's victory. He stands over your prostrate body and proclaims, ""Let this be a warning to all who would challenge the honour of the High King.""
"
	CALL1	RT-END-OF-GAME
	RSTACK	
...
"
	...
	PRINTI	"Your attention is distracted by something at the edge of the crowd. Lot siezes the moment to leap up, knock your sword aside and run you through.
"
	CALL1	RT-END-OF-GAME
	RSTACK	
...
?CCL5:	EQUAL?	HERE,RM-CHURCHYARD \?CCL7
	...
	JUMP	?CND1
?CCL7:	EQUAL?	HERE,RM-FIELD-OF-HONOUR,RM-SHALLOWS,RM-MID-LAKE \?CCL9
...
?CCL7:	EQUAL?	PRSA,V?LOOK-ON,V?EXAMINE \?CCL9
	...
	PRINTR	"It is a large stone that looks a little like an anvil. There is a jewelled sword protruding from it."
...
?CTR17:	PRINTI	" Merlin appears before you and says, ""He who would rule all England must be both wise and chivalrous, Arthur, yet you have shown yourself lacking in "
...
?CCL5:	EQUAL?	PRSA,V?BREAK \FALSE
	...
	PRINTI	"You are hovering over the Field of Honour. Below you to the south is the lake. The town lies to the northeast, and the meadow is just north of you.
"
	RFALSE	
