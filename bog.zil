...
<ROUTINE RT-TH-CRUTCH ("OPT" (CONTEXT <>))
	<COND
		(.CONTEXT
			<RFALSE>
		)
...
!\  In ,TH-COTTAGE-FIRE the ,TH-COTTAGE-FIRE the+verb ,WINNER "see"
		...
		(<TOUCH-VERB?>
			<COND
				...
				(T
					<TELL
The+verb ,WINNER "poke" " around in the ashes but find nothing of interest." CR
					>
				)
			>
		)
