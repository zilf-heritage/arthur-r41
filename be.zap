...
?CCL30:	EQUAL?	LOC?,GLOBAL-OBJECTS \?CCL32
	...
	ICALL	RT-PRINT-VERB,PRSO,STR?69
...
?CCL34:	FSET?	LOC?,FL-PERSON \?CCL38
	ICALL	RT-PRINT-OBJ,LOC?,K-ART-THE,TRUE-VALUE,STR?75
	ICALL	RT-PRINT-OBJ,PRSO,K-ART-THE
	PRINTR	"."
...
?CND1:	ICALL	RT-PRINT-VERB,PRSO,STR?69
	ZERO?	NOT? /FALSE
	PRINTI	"n't"
	RTRUE	
...
?CCL3:	GET	ADJ-TABLE,0
	...
	.FUNCT	V-CAN?:ANY:0:0
	CALL	YES-BUT?,STR?246,STR?247
	RSTACK	


	.FUNCT	V-MAY?:ANY:0:0
	CALL	YES-BUT?,STR?247,STR?246
	RSTACK	
	...
	CALL	YES-BUT?,STR?248,STR?249
	RSTACK	


	.FUNCT	V-WOULD?:ANY:0:0
	CALL	YES-BUT?,STR?249,STR?248
	RSTACK	


	.FUNCT	V-SHOULD?:ANY:0:0
	CALL	YES-BUT?,STR?250,STR?251
	RSTACK	


	.FUNCT	V-MIGHT?:ANY:0:0
	CALL	YES-BUT?,STR?252,STR?251
	RSTACK	


	.FUNCT	V-WILL?:ANY:0:0
	CALL	YES-BUT?,STR?251,STR?250
	RSTACK	


	.FUNCT	V-MUST?:ANY:0:0
	CALL	YES-BUT?,STR?253,STR?246
	RSTACK	
