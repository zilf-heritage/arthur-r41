	...
	PRINTI	" on a track next to a stand of horse chestnut trees. The track continues to the north and the southeast.
"
	RFALSE	
?CCL3:	EQUAL?	CONTEXT,M-BEG \?CCL5
	...
	PRINTI	", but"
	ICALL	RT-PRINT-OBJ,PRSO,K-ART-HE,FALSE-VALUE,STR?69
...
?CND26:	ICALL	RT-PRINT-OBJ,WINNER,K-ART-THE,TRUE-VALUE,STR?170
	PRINTI	" up"
	ICALL	RT-PRINT-OBJ,OBJ,K-ART-THE
	PRINTI	", but"
	ICALL	RT-PRINT-OBJ,OBJ,K-ART-HE,FALSE-VALUE,STR?69
	PRINTR	" not large enough to stop all the conkers from getting through."
...
?CND44:	ICALL	RT-PRINT-OBJ,WINNER,K-ART-THE,TRUE-VALUE,STR?170
	PRINTI	" up"
...
"
	...
	.FUNCT	RT-PS-CONKERS:ANY:0:3,CONTEXT,ART,CAP?
...
?CCL22:	ICALL2	THIS-IS-IT,PSEUDO-OBJECT
	...
	ICALL	RT-PRINT-OBJ,LG-CHESTNUT-TREES,K-ART-THE,TRUE-VALUE,STR?69
