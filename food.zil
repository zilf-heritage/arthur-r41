...
; "file : FOOD.ZIL"
; "auth :   $Author:   DEB  $"
; "date :     $Date:   27 Apr 1989 23:56:20  $"
; "revs : $Revision:   1.39  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
...
<OBJECT TH-CHEESE
	...
	(ADJECTIVE TASTY LOOKING TASTY-LOOKING)
	(OWNER TH-CHEESE)
	(SIZE 1)
	(GENERIC RT-GN-FOOD)
	(ACTION RT-TH-CHEESE)
...
<ROUTINE RT-TH-CHEESE ("OPT" (CONTEXT <>))
	<COND
		...
		(<VERB? EXAMINE>
			...
			<TELL "The cheese is a nicely aged piece of Stilton." CR>
		)
	;	(<VERB? SMELL>
...
<OBJECT TH-DEAD-MOUSE
	(LOC CH-IDIOT)
	(FLAGS FL-BURNABLE FL-HAS-SDESC FL-NO-DESC FL-TAKEABLE)
	(SYNONYM MOUSE FOOD)
