...
?CND32:	SET	'PO,PRSO
	...
	CALL	D-APPLY,STR?62,STACK,M-WINNER >V
?CND34:	ZERO?	PRSS /?CND37
	ZERO?	V \?CND39
	GETP	PRSS,P?ACTION
	CALL	D-APPLY,STR?63,STACK,M-SUBJ >V
?CND39:	ZERO?	V \?CND41
	ZERO?	PRSQ /?CND41
	GET	ACTIONS,PA >?TMP2
	ADD	QACTIONS,2 >?TMP1
...
?CND37:	ZERO?	V \?CND60
	...
	LOC	WINNER
	GETP	STACK,P?ACTION
	CALL	D-APPLY,STR?65,STACK,M-BEG >V
?CND60:	ZERO?	V \?CND64
	GETP	HERE,P?ACTION
	CALL	D-APPLY,STR?65,STACK,M-BEG >V
?CND64:	ZERO?	V \?CND66
...
?CND66:	SET	'NOW-PRSI,1
	...
	ZERO?	V /?CND68
	CALL	D-APPLY,STR?66,V,M-CONTAINER >V
?CND68:	ZERO?	V \?CND76
	ZERO?	PI /?CND76
	EQUAL?	PI,GLOBAL-HERE \?CND80
	GETP	HERE,P?ACTION
	CALL	D-APPLY,STR?67,STACK >V
?CND80:	ZERO?	V \?CND76
	GETP	PI,P?ACTION
	CALL	D-APPLY,STR?67,STACK >V
...
?CCL10:	CRLF	
	...
	EQUAL?	PRSA,V?TELL-ABOUT,V?THANK,V?YELL /TRUE
	RFALSE	
