...
?CND12:	PRINTI	" A dark passage leads down to the north. The fire"
...
?CCL3:	EQUAL?	CONTEXT,M-CONT \?CCL17
	CALL1	TOUCH-VERB?
	ZERO?	STACK /FALSE
	FSET?	TH-CASTLE-FIRE,FL-LIGHTED \?CCL23
	PRINT	K-HOT-MSG
	RTRUE	
?CCL23:	ZERO?	NOW-PRSI /?PRD27
	FSET?	PRSI,FL-AIR /?CCL25
?PRD27:	ZERO?	NOW-PRSI \FALSE
...
?CCL17:	ZERO?	CONTEXT \FALSE
	...
	RSTACK	
?CCL38:	EQUAL?	PRSA,V?PUT-IN,V?PUT \FALSE
	FSET?	TH-CASTLE-FIRE,FL-LIGHTED \FALSE
	EQUAL?	PRSO,CH-PLAYER,TH-HANDS,TH-LEGS /?CTR53
	EQUAL?	PRSO,TH-HEAD,TH-MOUTH \?CCL54
?CTR53:	PRINT	K-HOT-MSG
	RTRUE	
?CCL54:	FSET?	PRSO,FL-BURNABLE \FALSE
	REMOVE	PRSO
	PRINTI	"The flames leap higher, and soon"
	ICALL	RT-PRINT-OBJ,PRSO,K-ART-THE
	PRINTR	" can no longer be seen."
?CCL35:	EQUAL?	PRSA,V?ENTER \?CCL60
	EQUAL?	HERE,RM-BEHIND-FIRE \?CCL63
	CALL2	RT-DO-WALK,P?WEST
	RSTACK	
?CCL63:	EQUAL?	HERE,RM-CAS-KITCHEN \FALSE
	CALL2	RT-DO-WALK,P?EAST
	RSTACK	
?CCL60:	EQUAL?	PRSA,V?EXTINGUISH \?CCL67
	EQUAL?	PRSI,TH-BARREL,TH-BARREL-WATER \FALSE
	IN?	TH-BARREL-WATER,TH-BARREL \FALSE
	ZERO?	GL-PLAYER-FORM \?CCL76
	CALL1	RT-PUT-OUT-FIRE-MSG
	RSTACK	
?CCL76:	CALL2	RT-ANIMAL-CANT-MSG,STR?321
	RSTACK	
?CCL67:	EQUAL?	PRSA,V?EXAMINE \?CCL78
	FSET	TH-CASTLE-FIRE,FL-SEEN
	FSET?	TH-CASTLE-FIRE,FL-LIGHTED \?CCL82
	PRINTR	"It's a roaring fire that gives off intense heat."
?CCL82:	PRINTR	"The fire has gone out."
?CCL78:	EQUAL?	PRSA,V?LOOK-THRU \?CCL84
	ICALL	RT-PRINT-OBJ,WINNER,K-ART-THE,TRUE-VALUE
	PRINTR	" can't see much from here."
?CCL84:	EQUAL?	PRSA,V?PUT-THRU \?CCL86
	EQUAL?	HERE,RM-BEHIND-FIRE \?CCL89
	CALL1	IDROP
	ZERO?	STACK /FALSE
	CALL	RT-THROW-INTO-ROOM-MSG,PRSO,RM-CAS-KITCHEN
	RSTACK	
?CCL89:	EQUAL?	HERE,RM-CAS-KITCHEN \?CCL94
	CALL1	IDROP
	ZERO?	STACK /FALSE
	CALL	RT-THROW-INTO-ROOM-MSG,PRSO,RM-BEHIND-FIRE
	RSTACK	
?CCL94:	CALL2	NOT-HERE,PRSI
	RSTACK	
?CCL86:	EQUAL?	PRSA,V?LISTEN \?CCL99
	FSET?	TH-CASTLE-FIRE,FL-LIGHTED \FALSE
	PRINTR	"The fire roars like a furnace."
?CCL99:	CALL1	TOUCH-VERB?
	ZERO?	STACK /FALSE
	FSET?	TH-CASTLE-FIRE,FL-LIGHTED \FALSE
	PRINT	K-HOT-MSG
	RTRUE	
...
?CCL25:	ZERO?	CONTEXT \FALSE
	EQUAL?	PRSA,V?EXAMINE \?CCL38
	EQUAL?	HERE,RM-CAS-KITCHEN /FALSE
	FSET	RM-CAS-KITCHEN,FL-SEEN
	EQUAL?	HERE,RM-BEHIND-FIRE \?CCL44
	ICALL	RT-PRINT-OBJ,WINNER,K-ART-THE,TRUE-VALUE
	PRINTR	" can't see much from here."
?CCL44:	PRINTR	"It's a small building to the south of the great hall."
?CCL38:	EQUAL?	PRSA,V?THROW /?CCL46
	EQUAL?	PRSA,V?PUT-IN,V?PUT \FALSE
	EQUAL?	P-PRSA-WORD,W?THROW,W?TOSS,W?HURL /?CCL46
	EQUAL?	P-PRSA-WORD,W?CHUCK,W?FLING,W?PITCH /?CCL46
	EQUAL?	P-PRSA-WORD,W?HEAVE \FALSE
?CCL46:	EQUAL?	HERE,RM-BEHIND-FIRE \?CCL56
	CALL1	IDROP
	ZERO?	STACK /TRUE
	CALL	RT-THROW-INTO-ROOM-MSG,PRSO,RM-CAS-KITCHEN
	RSTACK	
?CCL56:	CALL2	NOT-HERE,PRSI
	RSTACK	
...
?CCL25:	EQUAL?	PRSA,V?RAISE,V?TAKE \?CCL30
	ICALL	RT-PRINT-OBJ,TH-BARREL,K-ART-THE,TRUE-VALUE,STR?69
...
?CCL32:	EQUAL?	PRSA,V?TIP,V?MOVE \?CCL44
	...
	CALL2	RT-ANIMAL-CANT-MSG,STR?214
	RSTACK	
?CCL47:	IN?	TH-BARREL-WATER,TH-BARREL \?CCL49
	CALL1	RT-PUT-OUT-FIRE-MSG
	RSTACK	
?CCL49:	CALL2	RT-NO-POINT-MSG,STR?194
	RSTACK	
...
?CCL58:	EQUAL?	GL-PLAYER-FORM,K-FORM-TURTLE \TRUE
	ICALL2	RT-ANIMAL-CANT-MSG,STR?322
	RTRUE	
...
?CCL84:	FCLEAR	LG-KITCHEN-DOOR,FL-LOCKED
	...
	ZERO?	DOOR \?CND1
	SET	'DOOR,PRSO
?CND1:	ICALL	RT-PRINT-OBJ,DOOR,K-ART-THE,TRUE-VALUE,STR?75
...
?CCL3:	FSET?	LG-BADGER-TAPESTRY,FL-LOCKED /?CTR7
	RETURN	RM-PASSAGE-1
?CTR7:	ICALL2	RT-YOU-CANT-MSG,STR?120
	RFALSE	
...
?CCL11:	ZERO?	CONTEXT \FALSE
	...
	.FUNCT	RT-PS-DAGGER:ANY:0:3,CONTEXT,ART,CAP?
	EQUAL?	CONTEXT,M-OBJDESC \?CCL3
