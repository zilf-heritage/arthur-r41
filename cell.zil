...
; "file : CELL.ZIL"
; "auth :   $Author:   DEB  $"
; "date :     $Date:   28 Apr 1989 18:08:22  $"
; "revs : $Revision:   1.89  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
; "Cell puzzle"
...
<OBJECT CH-PRISONER
	(LOC RM-CELL)
	(DESC "prisoner")
	(FLAGS FL-ALIVE FL-LOCKED FL-OPEN FL-PERSON FL-SEARCH FL-NO-DESC)
									...
									(T
										<COND
											(<AND <NOT <EQUAL? .OBJ ,TH-CELL-STONE>>
												...
												>
												<TELL
"sees" the .OBJ " and looks around the room. When he "
												>
												<COND
													(<MC-FORM? ,K-FORM-ARTHUR>
