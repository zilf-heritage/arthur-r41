...
?CCL15:	EQUAL?	GL-WINDOW-TYPE,K-WIN-PICT \TRUE
	...
	ADD	GL-MOVES,3
	ICALL	RT-QUEUE,RT-I-LEP-1,STACK
	PRINTI	"Momentarily startled, the leprechaun quickly recovers his composure and leaps into the bushes at the edge of the clearing. As he disappears, his tiny voice trails after him in triumph,"
	PRINT	K-SPRITE-MSG
	CRLF	
...
You "
	...
	PRINTC	46
	IN?	TH-SPICE-BOTTLE,RM-GLADE \?CCL11
	...
	IN?	TH-SPICE,TH-SPICE-BOTTLE \?CCL14
	ADD	GL-MOVES,1
...
?CCL8:	ADD	GL-MOVES,3
	...
	FSET	CH-LEPRECHAUN,FL-LOCKED
	JUMP	?CND4
?CCL6:	CALL2	RT-IS-QUEUED?,RT-I-SLEEP
	ADD	STACK,3
	ICALL	RT-QUEUE,RT-I-LEP-1,STACK
...
?CCL22:	EQUAL?	PRSA,V?WALK /FALSE
	EQUAL?	PRSA,V?PUT-IN \?PRD30
	EQUAL?	PRSI,RM-GLADE /?CTR27
?PRD30:	EQUAL?	PRSA,V?THROW \?CCL28
	IN?	PRSI,RM-GLADE \?CCL28
?CTR27:	CALL1	PRE-PUT
	ZERO?	STACK \TRUE
	CALL1	IDROP
	ZERO?	STACK /TRUE
	IN?	CH-LEPRECHAUN,RM-GLADE \?CCL41
	BOR	GL-UPDATE-WINDOW,3 >GL-UPDATE-WINDOW
	MOVE	PRSO,RM-GLADE
	CALL1	RT-L-STARTLED-MSG
	RSTACK	
?CCL41:	BOR	GL-UPDATE-WINDOW,3 >GL-UPDATE-WINDOW
	MOVE	PRSO,RM-GLADE
	...
	ICALL	RT-PRINT-OBJ,RM-GLADE,K-ART-THE
	PRINTR	"."
?CCL28:	IN?	CH-LEPRECHAUN,RM-GLADE \?CCL43
	CALL1	UNHIDE-VERB?
	ZERO?	STACK /?CCL43
	ICALL1	RT-L-STARTLED-MSG
	EQUAL?	PRSA,V?TRANSFORM \TRUE
	RFALSE	
?CCL43:	CALL1	TOUCH-VERB?
	ZERO?	STACK /FALSE
	LOC	CH-PLAYER >L
	ZERO?	PRSO /?CND51
	EQUAL?	PRSO,ROOMS /?CND51
	LOC	PRSO
	EQUAL?	STACK,GLOBAL-OBJECTS,GENERIC-OBJECTS /?CND51
	CALL	RT-META-IN?,PRSO,L
	ZERO?	STACK \?CND51
	EQUAL?	PRSO,TH-ROCK /FALSE
	ICALL	RT-CANT-REACH-MSG,PRSO,L
	RTRUE	
?CND51:	ZERO?	PRSI /FALSE
	...
	ICALL	RT-ALREADY-MSG,WINNER,STR?367
	RFALSE	
...
?CCL7:	MOVE	WINNER,TH-BEHIND-ROCK
	...
	ICALL	RT-PRINT-OBJ,WINNER,K-ART-THE,TRUE-VALUE,STR?368
	PRINTI	" behind"
	ICALL	RT-PRINT-OBJ,TH-ROCK,K-ART-THE
...
?CCL3:	EQUAL?	GL-HIDING,TH-ROCK \?CCL5
	...
	JUMP	?CND6
?CCL8:	ICALL	RT-PRINT-OBJ,WINNER,K-ART-THE,TRUE-VALUE,STR?369
	PRINTI	" from"
	EQUAL?	GL-HIDING,TH-ROCK \?CND9
	PRINTI	" hiding"
?CND9:	ICALL	RT-PRINT-OBJ,TH-BEHIND-ROCK,K-ART-THE
	PRINTI	" and"
	ICALL	RT-PRINT-VERB,WINNER,STR?69
	PRINTI	" now in"
	ICALL	RT-PRINT-OBJ,RM-GLADE,K-ART-THE
	PRINTC	46
	CRLF	
...
?CCL5:	ICALL1	RT-UNDERGROWTH
	...
	.FUNCT	RT-TH-WHISKY-JUG:ANY:0:1,CONTEXT,N,TBL,OBJ,?TMP1
	ZERO?	CONTEXT \FALSE
	ZERO?	NOW-PRSI /?CCL5
...
?CCL10:	EQUAL?	PRSA,V?READ,V?EXAMINE \?CCL17
	...
	CRLF	
	DIROUT	K-D-TBL-ON,K-DIROUT-TBL
	PRINTI	"MOTHER MACREE'S IRISH WHISKY"
	DIROUT	K-D-TBL-OFF,K-DIROUT-TBL
	WINGET	-3,K-W-YCURPOS >?TMP1
	GET	0,24
	SUB	N,STACK
...
?BOGUS42:	REMOVE	OBJ
	...
	ICALL	RT-PRINT-OBJ,TH-WHISKY-JUG,K-ART-THE
	PRINTC	46
	FSET?	HERE,FL-WATER \?CCL45
	PRINTI	" It disappears into the water."
	JUMP	?CND43
?CCL45:	PRINT	K-EVAPORATES-MSG
?CND43:	CRLF	
	EQUAL?	OBJ,TH-WHISKY \TRUE
	ICALL	RT-SCORE-MSG,0,-1,0,0
	RTRUE	
?CCL36:	EQUAL?	PRSA,V?OPEN \FALSE
	CALL	RT-ALREADY-MSG,TH-WHISKY-JUG,STR?178
	RSTACK	


	.FUNCT	RT-GN-WHISKY:ANY:2:2,TBL,FINDER
	GET	PARSE-RESULT,4
	EQUAL?	STACK,V?DRINK \?CCL3
	RETURN	TH-WHISKY
?CCL3:	PRINTC	91
...
?CCL3:	EQUAL?	PRSA,V?EXAMINE \FALSE
	...
	PRINTR	"It has a deep, amber colour."
