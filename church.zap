...
?CCL3:	ZERO?	CONTEXT \FALSE
	...
	CALL2	RT-IS-QUEUED?,RT-I-SOLDIER-3
	ZERO?	STACK /FALSE
?CCL19:	ICALL	RT-PRINT-OBJ,CH-SOLDIERS,K-ART-THE,TRUE-VALUE
	PRINTI	"are"
...
?CCL7:	EQUAL?	V,V?POLISH \?CCL13
	...
	CRLF	
	RETURN	TH-PUMICE
?CCL13:	EQUAL?	HERE,RM-BOAT-ROOM \?CCL17
	RETURN	TH-STONE
?CCL17:	INTBL?	P-IT-OBJECT,PTR,N \?CCL19
	RETURN	P-IT-OBJECT
?CCL19:	INTBL?	TH-CELL-STONE,PTR,N \?CCL21
	RETURN	TH-CELL-STONE
?CCL21:	INTBL?	TH-STONE,PTR,N \?CCL23
	RETURN	TH-STONE
?CCL23:	INTBL?	TH-PUMICE,PTR,N \?CCL25
	PRINTC	91
	ICALL	RT-PRINT-OBJ,TH-PUMICE,K-ART-THE,TRUE-VALUE
	PRINTC	93
	CRLF	
	RETURN	TH-PUMICE
?CCL25:	INTBL?	TH-ROCK,PTR,N \?CCL27
	RETURN	TH-ROCK
?CCL27:	INTBL?	TH-GRAVESTONE,PTR,N \FALSE
	PRINTC	91
	ICALL	RT-PRINT-OBJ,TH-GRAVESTONE,K-ART-THE,TRUE-VALUE
	PRINTC	93
	CRLF	
	...
	RSTACK	
?CCL6:	EQUAL?	PRSA,V?PUT-IN \?PRD12
	EQUAL?	PRSI,RM-CHURCHYARD /?CTR9
?PRD12:	EQUAL?	PRSA,V?THROW \?CCL10
	IN?	PRSI,RM-CHURCHYARD \?CCL10
?CTR9:	CALL1	PRE-PUT
	ZERO?	STACK \TRUE
	CALL1	IDROP
	ZERO?	STACK /TRUE
...
?CND24:	ZERO?	PRSI /FALSE
	...
	ICALL	RT-ALREADY-MSG,WINNER,STR?408
	RFALSE	
...
?PST10:	SET	'HIDE,1
?PEN9:	ZERO?	HIDE /?CCL8
	ICALL	RT-PRINT-VERB,WINNER,STR?409
	JUMP	?CND6
?CCL8:	ICALL	RT-PRINT-VERB,WINNER,STR?410
	PRINTI	" around"
?CND6:	PRINTI	" behind"
	ICALL	RT-PRINT-OBJ,TH-GRAVESTONE,K-ART-THE
	ZERO?	HIDE /?CND16
	...
	PRINTI	" and"
	ICALL	RT-PRINT-VERB,WINNER,STR?411
...
"
	...
	ICALL1	RT-UPDATE-PICT-WINDOW
	RFALSE	
?CCL20:	EQUAL?	GL-WINDOW-TYPE,K-WIN-DESC \FALSE
...
?CCL8:	FSET?	LG-CHURCH-GATE,FL-OPEN \?CCL10
	CALL	RT-ALREADY-MSG,LG-CHURCH-GATE,STR?178
	RSTACK	
...
?CCL5:	EQUAL?	PRSA,V?CLOSE \?CCL17
	...
	CALL	RT-ALREADY-MSG,LG-CHURCH-GATE,STR?161
	RSTACK	
...
?CCL24:	EQUAL?	PRSA,V?CLIMB-OVER,V?CLIMB-ON,V?CLIMB-UP \FALSE
	...
	ICALL	RT-PRINT-OBJ,PERSON,K-ART-THE,FALSE-VALUE,STR?414
	PRINTI	" you and"
	ICALL	RT-PRINT-VERB,PERSON,STR?415
...
"
	...
	ICALL1	RT-UPDATE-DESC-WINDOW
	RTRUE	
?CCL5:	EQUAL?	HERE,RM-CHURCH \TRUE
...
?CCL14:	EQUAL?	GL-WINDOW-TYPE,K-WIN-PICT \TRUE
	...
	.FUNCT	RT-I-SOLDIER-4:ANY:0:0,N
	FSET	CH-PLAYER,FL-ASLEEP
	PRINTI	"
You settle down to a long vigil of waiting. Despite the excitement of the evening, you soon become drowsy and fall asleep.
"
	MOD	GL-MOVES,1440
	SUB	540,STACK >N
	LESS?	N,0 \?CND1
	ADD	N,1440 >N
?CND1:	ADD	GL-MOVES,N >GL-MOVES
...
?CND1:	ADD	GL-MOVES,N
	...
	SET	'GL-HUNGER,1
	PRINTI	"
Hours later you are awakened by the sound of the church bell ringing. A crowd is gathering in the churchyard, and King Lot is standing on the steps of the church. Above his head, he brandishes a jeweled sword that looks exactly like the sword that was imbedded in the stone.
...
""Three days hence - at noon on Christmas day - shall I be coronated on this very spot. If any man dares to contest my claim, let him come to my hall and challenge me in the traditional manner of knighthood, and I will do battle with him.""
...
?CCL15:	ICALL	RT-PRINT-OBJ,WINNER,K-ART-THE,TRUE-VALUE,STR?176
	PRINTI	" for a moment"
	FSET?	CH-PLAYER,FL-BROKEN /?CND20
	PRINTC	44
	ICALL	RT-PRINT-VERB,WINNER,STR?200
...
?CCL3:	EQUAL?	PRSA,V?LOOK-ON,V?EXAMINE \?CCL14
	ICALL2	THIS-IS-IT,PSEUDO-OBJECT
	PRINTR	"The benches look very uncomfortable."
?CCL14:	EQUAL?	PRSA,V?LIE-DOWN,V?SIT,V?PUT \?CCL16
	ICALL2	THIS-IS-IT,PSEUDO-OBJECT
	PRINTI	"The bench seats are all tilted forward. "
	ICALL	RT-PRINT-OBJ,WINNER,K-ART-THE,TRUE-VALUE
	PRINTI	" can't "
