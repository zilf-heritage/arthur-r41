...
<ROUTINE RT-RM-DEMON-HALL ("OPT" (CONTEXT <>))
	<COND
		(<MC-CONTEXT? ,M-F-LOOK ,M-V-LOOK ,M-LOOK>
			...
			>
			<TELL
" a long, narrow banqueting hall that is panelled in dark oak. High above you,
the walls are lined with the shields of vanquished knights. At the far end "
			>
			<COND
				(<MC-CONTEXT? ,M-F-LOOK>
					<TELL
...
The ,LG-HOT-DOOR " slams shut behind you with an ominous \"clank.\" "
			...
			>
			<TELL
"\"So, Arthur, you have seen through my little disguise. But as I am feeling
generous, I shall make you a bargain. We each have something the other wants.
I have" the ,TH-FLEECE ", without which you cannot claim your kingdom. You
have the power to free me. I propose a trade.\"||\"Heed closely the words of
my offer, for I will fulfill them to the letter. If you agree to unlock my "
			>
			<COND
				(<OR	<FSET? ,TH-LEFT-MANACLE ,FL-OPEN>
						<FSET? ,TH-RIGHT-MANACLE ,FL-OPEN>
...
<ROUTINE RT-TH-MANACLES ("OPT" (CONTEXT <>))
	<COND
		...
		(<VERB? EXAMINE>
			...
			<FSET ,TH-LEFT-MANACLE ,FL-SEEN>
			<FSET ,TH-RIGHT-MANACLE ,FL-SEEN>
			<TELL The+verb ,TH-MANACLES "are" " made of pure gold." CR>
		)
		(<VERB? OPEN UNLOCK>
			<COND
				(<AND <MC-PRSI? <> ,TH-GOLD-KEY>
