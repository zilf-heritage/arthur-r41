...
?CCL44:	EQUAL?	HERE,RM-NORTH-OF-CHASM \FALSE
	CALL2	RT-DO-WALK,P?SOUTH
	RSTACK	
?CCL41:	EQUAL?	PRSA,V?ENTER \?CCL48
...
?CCL48:	EQUAL?	PRSA,V?LOOK-IN,V?EXAMINE \FALSE
	FSET	LG-CHASM,FL-SEEN
...
?CCL6:	MOVE	OBJ,RM-NORTH-OF-CHASM
	...
	ICALL2	THIS-IS-IT,TH-BOAR
	ICALL	RT-PRINT-OBJ,OBJ,K-ART-THE,TRUE-VALUE,STR?212
	PRINTI	" through the air and"
	ICALL	RT-PRINT-VERB,OBJ,STR?241
	PRINTI	" on the ground near"
	ICALL	RT-PRINT-OBJ,TH-BOAR,K-ART-THE
	PRINTC	46
	CRLF	
	BOR	GL-UPDATE-WINDOW,K-UPD-INVT
	BOR	STACK,K-UPD-DESC >GL-UPDATE-WINDOW
...
?CND11:	BOR	GL-UPDATE-WINDOW,K-UPD-INVT >GL-UPDATE-WINDOW
	ICALL2	THIS-IS-IT,OBJ
	ICALL	RT-PRINT-OBJ,OBJ,K-ART-THE,TRUE-VALUE,STR?241
...
?CCL42:	CALL1	IDROP
	ZERO?	STACK /FALSE
	MOVE	PRSO,RM-NORTH-OF-CHASM
	ICALL	RT-PRINT-OBJ,PRSO,K-ART-THE,TRUE-VALUE,STR?256
	ICALL	RT-PRINT-OBJ,TH-BOAR,K-ART-THE
	PRINTI	" and"
	ICALL	RT-PRINT-VERB,PRSO,STR?241
...
?CCL54:	EQUAL?	PRSA,V?EXAMINE \?CCL58
	...
	ICALL	RT-PRINT-OBJ,TH-BOAR,K-ART-THE,TRUE-VALUE
	PRINTR	" is several hundred angry pounds of pure visciousness. He has only one tusk, and a gaping hole where the other one used to be."
...
?CCL8:	EQUAL?	GL-WINDOW-TYPE,K-WIN-PICT \TRUE
	ICALL1	RT-UPDATE-PICT-WINDOW
	RTRUE	
?CCL5:	ICALL	RT-PRINT-OBJ,TH-BOAR,K-ART-THE,TRUE-VALUE
	PRINTI	" slams into you at full speed, ripping your flesh open with his tusk and severing an artery. You fall to the ground and discover with dismay how little time it takes to bleed to death.
"
	CALL1	RT-END-OF-GAME
	RSTACK	
...
?CCL7:	IN?	TH-TUSK,TH-BOAR \FALSE
	...
	PRINTC	46
	CRLF	
	CALL2	RT-AUTHOR-MSG,STR?270
	RSTACK	
?CCL11:	EQUAL?	PRSA,V?CUT \FALSE
	EQUAL?	PRSI,TH-SWORD \FALSE
	FSET?	TH-BOAR,FL-ALIVE \?CCL18
	PRINTI	"You take a wild swing at"
	ICALL	RT-PRINT-OBJ,TH-TUSK,K-ART-THE
	PRINTR	", but miss."
?CCL18:	FSET	TH-TUSK,FL-TAKEABLE
...
?CND19:	BOR	GL-UPDATE-WINDOW,K-UPD-DESC >GL-UPDATE-WINDOW
	EQUAL?	GL-WINDOW-TYPE,K-WIN-DESC \TRUE
	ICALL1	RT-UPDATE-DESC-WINDOW
	RTRUE	
