...
; "file : IKNIGHT.ZIL"
; "auth :   $Author:   RAB  $"
; "date :     $Date:   01 May 1989 12:41:54  $"
; "revs : $Revision:   1.81  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
...
tell the difference between it and the real thing."
				...
				(<MC-PRSI? ,CH-I-KNIGHT>
					<TELL
"\"Oh, I do alright. Business is better in the summer, though.\"" CR
					>
				)
				(<MC-PRSI? ,CH-MERLIN>
					<TELL
...
<ROUTINE RT-QUIZ ("AUX" VAL I N PTR (WIN? <>))
	<TELL
"|\"Alright then. I'm a sporting man. If you can tell me the next two
...
"\"Yes. That's it. Very Good. Here you are.\" He hands you the brass egg." CR
		...
		>
		<TELL "\"Alright then. What is your next guess?\"" CR>
	>
