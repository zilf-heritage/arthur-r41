	...
	EQUAL?	LOSS,2 \?CND1
	PRINTI	"in"
?CND1:	PRINTI	"direct object with """
...
?CND1:	GET	0,8
	...
	ZERO?	LOOK? /?CND3
	ICALL1	V-LOOK
?CND3:	EQUAL?	HERE,RM-EDGE-OF-WOODS \?CND5
	IN?	CH-PLAYER,TH-HORSE \?CND5
	IN?	CH-BLUE-KNIGHT,RM-EDGE-OF-WOODS \?CND5
	ICALL	SETUP-ORPHAN-NP,STR?72,TH-RED-LANCE,TH-GREEN-LANCE
	PRINTI	"
""Well lad,"" says the knight. """
	PRINT	K-WHICH-LANCE-MSG
?CND5:	EQUAL?	GL-WINDOW-TYPE,K-WIN-INVT \?CCL12
	ICALL2	RT-UPDATE-INVT-WINDOW,TRUE-VALUE
	RTRUE	
?CCL12:	EQUAL?	GL-WINDOW-TYPE,K-WIN-DESC \?CCL14
	ICALL2	RT-UPDATE-DESC-WINDOW,TRUE-VALUE
	RTRUE	
?CCL14:	EQUAL?	GL-WINDOW-TYPE,K-WIN-STAT \?CCL16
	ICALL2	RT-UPDATE-STAT-WINDOW,TRUE-VALUE
	RTRUE	
?CCL16:	EQUAL?	GL-WINDOW-TYPE,K-WIN-MAP \?CCL18
	ICALL2	RT-UPDATE-MAP-WINDOW,TRUE-VALUE
	RTRUE	
?CCL18:	EQUAL?	GL-WINDOW-TYPE,K-WIN-PICT \TRUE
...
?PEN20:	BAND	STACK,4
	BAND	STACK,32767
	ZERO?	STACK /?CND1
?CCL2:	ICALL2	MISSING,STR?73
	RTRUE	
?CND1:	CALL2	RT-AUTHOR-MSG,STR?74
	RSTACK	
...
?CND4:	PRINTC	33
	...
	.FUNCT	NP-CANT-SEE:ANY:0:1,NP,TMP
	ASSIGNED?	'NP /?CND1
	CALL1	GET-NP >NP
?CND1:	GET	NP,2 >TMP
	ZERO?	TMP /?CCL5
